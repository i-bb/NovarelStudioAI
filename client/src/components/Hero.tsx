    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden pt-24 pb-16">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 grid md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-6 md:gap-8 lg:gap-12 items-stretch">
        ...
        <div>
          ...
          <h1
            className="font-display font-semibold text-4xl sm:text-5xl lg:text-6xl xl:text-7xl tracking-tight leading-[1.05] text-foreground mb-6"
            style={{ fontFamily: "'Porcine Bosk', var(--font-display)" }}
          >
          ...
          <p className="text-base sm:text-lg text-muted-foreground/90 max-w-xl leading-relaxed mb-8">
            NovarelStudio watches your stream end-to-end, finds the moments your
            chat loses its mind, and ships vertical clips automatically.
          </p>

          <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 mb-6">
            <Link href="/signup">
              <Button
                className="w-full h-12 sm:h-14 px-5 sm:px-8 text-xs sm:text-sm md:text-base font-semibold rounded-full bg-white text-black hover:bg-slate-100 shadow-[0_18px_60px_rgba(15,23,42,0.8)]"
        ...
        <div className="relative self-stretch flex flex-col">
          ...
          <div className="relative flex-1 rounded-3xl border border-white/8 bg-gradient-to-b from-slate-900/80 via-slate-950/95 to-black/95 shadow-[0_24px_80px_rgba(15,23,42,0.95)] overflow-hidden flex flex-col min-h-[520px]">
            ...
            <div className="flex flex-col xl:flex-1 xl:grid xl:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] gap-0">
              {/* Live stream preview */}
              <div className="relative border-r border-white/5 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.25),_transparent_65%) h-[220px] xl:h-full">
                <img
                  src={streamerImage}
                  alt="Live streaming"
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-end justify-between gap-3">
                  ...
                  <div className="flex gap-1.5">
                    <span
                      className="rounded-full bg-black/75 p-1.5 border border-emerald-400/30 flex items-center justify-center"
                      title="Clip queued"
                    >
                ...
                <div className="flex items-center justify-between mb-1">
                  <div>
                    ...
                    <p className="text-sm font-semibold text-slate-50">
                      6 clips generated • 3 auto-published
                    </p>
                  </div>
                  <span className="rounded-md lg:rounded-full bg-emerald-400/20 border border-emerald-400/40 px-1 lg:px-3 py-1.5 text-[8px] lg:text-[11px] font-semibold text-emerald-300">
                    Approve all
                  </span>
                </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0 flex items-center justify-between gap-2">
                        <div>
                          ...
                          <span className="mt-0.5 inline-flex rounded-full bg-slate-900/80 px-1.5 py-0.5 border border-white/10 text-[11px] text-muted-foreground">
                            {clip.tag}
                          </span>
                        </div>
