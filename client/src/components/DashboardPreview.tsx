            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="projects" className="px-4 sm:px-6 py-5 space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-2">
                  <div>
                    <h3 className="font-display text-sm sm:text-base font-semibold text-foreground">Recent streams</h3>
              ...
              <TabsContent value="ai-clipping" className="px-4 sm:px-6 py-10">
                <div className="mx-auto max-w-md text-center">
                  ...
                  <h3 className="font-display mb-2 text-base sm:text-lg font-semibold text-foreground">AI clipping engine</h3>
              ...
              <TabsContent value="settings" className="px-4 sm:px-6 py-5">
                <div className="max-w-xl space-y-4">
                  <h3 className="font-display text-sm sm:text-base font-semibold text-foreground mb-1">Posting rules</h3>
